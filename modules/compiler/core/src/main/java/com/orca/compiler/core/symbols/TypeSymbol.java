...
public interface TypeSymbol extends TypedSymbol, NamespaceOrTypeSymbol {
    ...
    /**
     * Adds an extension symbol to this type symbol. This method is used to associate extension symbols with the type symbol they extend.
    ...
    /**
     * Gets the list of member symbols of this type symbol, including members declared in this type symbol and members added through extensions.
     * @return The list of member symbols of this type symbol, including members declared in this type symbol and members added through extensions.
     */
    ...
    /**
     * Gets the list of member symbols with the specified name from this type symbol, including members declared in this type symbol and members added through extensions.
     * @param name The name of the member symbols to retrieve.
     * @return The list of member symbols with the specified name from this type symbol, including members declared in this type symbol and members added through extensions.
     */
    ...
    /**
     * Gets a member symbol with the specified name from this type symbol, including members declared in this type symbol and members added through extensions. If multiple members with the same name exist, the member declared in this type symbol is returned. If no member with the specified name exists, null is returned.
     * @param name The name of the member symbol to retrieve.
     * @return A member symbol with the specified name from this type symbol, including members declared in this type symbol and members added through extensions, or null if no such member exists.
     */
    ...
    /**
     * Checks if a member symbol with the specified name exists in this type symbol, including members declared in this type symbol and members added through extensions.
     * @param name The name of the member symbol to check for existence.
     * @return True if a member symbol with the specified name exists in this type symbol, including members declared in this type symbol and members added through extensions, false otherwise.
     */

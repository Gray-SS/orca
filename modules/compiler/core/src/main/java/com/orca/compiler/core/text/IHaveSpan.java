...
/**
 * An interface for things that have a source span. This is used for symbols,
 * syntax nodes, and other entities that can be traced back to a location in the
 * source code.
 */
public interface IHaveSpan extends IHaveLocation {

    /**
     * Gets the source span of this entity. For symbols, this is typically the
     * span of the syntax node that declares the symbol. For syntax nodes, this
     * is the span of the node itself.
     *
     * @return
     */
    SourceSpan span();

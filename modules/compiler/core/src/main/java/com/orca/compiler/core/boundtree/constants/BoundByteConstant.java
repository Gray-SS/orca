...
public final class BoundByteConstant extends BoundNumericConstant {
    ...
    public BoundNumericConstant add(BoundNumericConstant other) {
        return switch (other) {
            case BoundByteConstant b ->
                new BoundByteConstant((byte) (value + b.value()));
    ...
    public int compareTo(BoundNumericConstant other) {
        return switch (other) {
            ...
            default ->
                throw new UnsupportedOperationException("Incompatible constant types");
        };
    }
    ...
    public BoundConstant convertTo(LangType targetType) {
        return switch (targetType.getPrimitiveKind()) {
            ...
            case Bool, Char, String, None ->
                throw new IllegalArgumentException("Cannot convert byte to " + targetType);
        };
    }
}
